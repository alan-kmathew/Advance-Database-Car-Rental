...
const FormComponent = ({ locations, allLocations, selectedLocation, onLocationChange, fromDate, setFromDate, toDate, setToDate, destination, setDestination, onSearch }) => {
